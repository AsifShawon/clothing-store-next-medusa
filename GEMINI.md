...
2. **Medusa v2 Architecture**: Use Medusa workflows for business logic, file-based routes in `src/api`, and native built-in Admin at `/app`. Never build a custom admin dashboard or rewrite with NestJS.
